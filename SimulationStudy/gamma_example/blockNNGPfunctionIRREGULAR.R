...
# Recovering the posterior mean estimation of precision parameter  of gamma distribution,
# marginal variance and phi parameters.
...
summary.theta 	<- c(prec.gamma, sigmasq.est, phi.est)

print( c("prec.gamma","sigmasq.est","phi.est"))
print(summary.theta)
