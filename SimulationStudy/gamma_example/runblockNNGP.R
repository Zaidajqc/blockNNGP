...
setwd("//Users/zquiroz/Documents/ZAIDA_MAC/PAPERS/blockNNGP/review3STCO/block-NNGP-SIM2/")
...
b         <- mu / precision.gamma
y         <- rgamma(nloc,  shape = precision.gamma,  scale = b)

# for more information of this Zero inflated Poisson distribution visit
